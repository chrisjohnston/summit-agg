...
class tweetOauth extends tweetConnection {
	...
	function __construct()
	{
		...
		$this->_tokens = array(
			'consumer_key'=>Fl_Config::get('twitter', 'consumer_key'),
			'consumer_secret'=>Fl_Config::get('twitter', 'consumer_secret'),
	...
	{
		unset($_SESSION['userdata']['social']['twitter']['twitter_oauth_tokens']);
	}
	...
	{
		$tokens = $_SESSION['userdata']['social']['twitter']['twitter_oauth_tokens'];
	...
	private function _setAccessKey($access_key)
	{
		...
		$_SESSION['userdata']['social']['twitter']['twitter_oauth_tokens'] = $tokens;
	}
