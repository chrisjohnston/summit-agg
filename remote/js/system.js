$(document).ready(function() {
	$.Juitter.start({
		...
		searchObject:"%23linuxplumbers", // %23linuxplumbers,  needed, you can insert a username here or a word to be searched for, if you wish multiple search, separate the words by comma.
		...
		//imgName: "/remote/images/ajax-loader.gif", // Loading image, to enable it, go to the loadMSG var above and change it to "image/gif"
